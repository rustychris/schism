...
!          sframe2(3,1,i)=0.d0
!          sframe2(1,2,i)=-cos(ar1)*sin((ylat(n1)+ylat(n2))/2) !meri. dir.
!          sframe2(2,2,i)=-sin(ar1)*sin((ylat(n1)+ylat(n2))/2)
!          sframe2(3,2,i)=rearth_pole/rearth_eq*cos((ylat(n1)+ylat(n2))/2)
